class VencimientosController < BaseController
  ...
  private
    ...
    def vencimiento_params
      params.require(:vencimiento).permit(:Equipo_id, :FechaInicion, :FechaFinal, :Comentario, :IdTipoVencimiento, :IdEstadoVencimiento, :Referencia, :eliminado)
    end
end
