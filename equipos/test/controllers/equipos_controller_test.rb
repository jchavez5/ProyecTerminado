...
class EquiposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipo" do
    assert_difference('Equipo.count') do
      post equipos_url, params: { equipo: { IdArea: @equipo.IdArea, IdEstadoEquipo: @equipo.IdEstadoEquipo, IdTipoEquipo: @equipo.IdTipoEquipo, Modelo: @equipo.Modelo, Placa: @equipo.Placa, Serie: @equipo.Serie, eliminado: @equipo.eliminado } }
    end
  ...
  test "should update equipo" do
    patch equipo_url(@equipo), params: { equipo: { IdArea: @equipo.IdArea, IdEstadoEquipo: @equipo.IdEstadoEquipo, IdTipoEquipo: @equipo.IdTipoEquipo, Modelo: @equipo.Modelo, Placa: @equipo.Placa, Serie: @equipo.Serie, eliminado: @equipo.eliminado } }
